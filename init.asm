...
main(void)
{
  ...
  b4:	50                   	push   %eax
  b5:	50                   	push   %eax
  b6:	68 10 0b 00 00       	push   $0xb10
  bb:	68 3d 08 00 00       	push   $0x83d
  c0:	e8 c5 02 00 00       	call   38a <exec>
      printf(1, "init: exec sh failed\n");
  c5:	5a                   	pop    %edx
  c6:	59                   	pop    %ecx
  c7:	68 40 08 00 00       	push   $0x840
  cc:	6a 01                	push   $0x1
  ...
  d9:	6a 01                	push   $0x1
  db:	6a 01                	push   $0x1
  dd:	68 0e 08 00 00       	push   $0x80e
  e2:	e8 b3 02 00 00       	call   39a <mknod>
    open("/console", O_RDWR);
  e7:	58                   	pop    %eax
  e8:	5a                   	pop    %edx
  e9:	6a 02                	push   $0x2
  eb:	68 0e 08 00 00       	push   $0x80e
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	e9 8f fe ff ff       	jmp    4f8 <printf+0x48>
          s = "(null)";
 669:	bb 5f 08 00 00       	mov    $0x85f,%ebx
        while(*s != 0){
