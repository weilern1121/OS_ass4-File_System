...
void executeMultiLSND();
void getProcNameFile(char *name);
void getProcStatusFile(char *name);
...
int main(int argc, char *argv[]){
    ...
    char *theFile1 = "aFile1";
    char *theFile2 = "aFile2";
    char *theFile3 = "aFile3";
    char *theFile4 = "aFile4";
    char *theFile5 = "aFile5";
    char *theFile6 = "aFile6";
    char *theFile7 = "aFile7";
    char *theFile8 = "aFile8";
    char *theFile9 = "aFile9";
    char *theFile10 = "aFile10";
    char *theFile11 = "aFile11";
    char *theFile12 = "aFile12";
    char *theFile13 = "aFile13";
    char *theFile14 = "aFile14";
    char *theFile15 = "aFile15";
    char *theFile16 = "aFile16";
    char *theFile17 = "aFile17";
    char *theFile18 = "aFile18";
    char *theFile19 = "aFile19";
    char *theFile20 = "aFile20";
    char *theFile21 = "aFile21";
    char *theFile22 = "aFile22";
    char *theFile23 = "aFile23";
    char *theFile24 = "aFile24";
    char *theFile25 = "aFile25";
    char *theFile26 = "aFile26";
    char *theFile27 = "aFile27";
    char *theFile28 = "aFile28";
    char *theFile29 = "aFile29";
    char *theFile30 = "aFile30";

    if((pid = fork()) == 0){

      createAndOpenFileInBlocks(theFile1, 1, 1);
      createAndOpenFileInBlocks(theFile2, 1, 1);
      createAndOpenFileInBlocks(theFile3, 1, 1);
      createAndOpenFileInBlocks(theFile4, 1, 1);
      createAndOpenFileInBlocks(theFile5, 1, 1);
      createAndOpenFileInBlocks(theFile6, 1, 1);
      createAndOpenFileInBlocks(theFile7, 1, 1);
      createAndOpenFileInBlocks(theFile8, 1, 1);
      createAndOpenFileInBlocks(theFile9, 1, 1);
      createAndOpenFileInBlocks(theFile10,1, 1);
      createAndOpenFileInBlocks(theFile11, 1, 1);
      createAndOpenFileInBlocks(theFile12, 1, 1);
    ...
    if((pid = fork()) == 0){
      createAndOpenFileInBlocks(theFile13, 1, 1);
      createAndOpenFileInBlocks(theFile14, 1, 1);
      createAndOpenFileInBlocks(theFile15, 1, 1);
      createAndOpenFileInBlocks(theFile16, 1, 1);
      createAndOpenFileInBlocks(theFile17, 1, 1);
      createAndOpenFileInBlocks(theFile18, 1, 1);
      createAndOpenFileInBlocks(theFile19, 1, 1);
      createAndOpenFileInBlocks(theFile20, 1, 1);
      createAndOpenFileInBlocks(theFile21, 1, 1);
    ...
    if((pid = fork()) == 0){
      createAndOpenFileInBlocks(theFile22, 1, 1);
      createAndOpenFileInBlocks(theFile23, 1, 1);
      createAndOpenFileInBlocks(theFile24, 1, 1);
      createAndOpenFileInBlocks(theFile25, 1, 1);
      createAndOpenFileInBlocks(theFile26, 1, 1);
      createAndOpenFileInBlocks(theFile27, 1, 1);
      createAndOpenFileInBlocks(theFile28, 1, 1);
      createAndOpenFileInBlocks(theFile29, 1, 1);
      createAndOpenFileInBlocks(theFile30, 1, 1);
    ...
    assertFileInLSNDparsingData(theFile1,0);
    assertFileInLSNDparsingData(theFile2,0);
    assertFileInLSNDparsingData(theFile3,0);
    assertFileInLSNDparsingData(theFile4, 0);
    assertFileInLSNDparsingData(theFile5, 0);
    assertFileInLSNDparsingData(theFile6,0);
    assertFileInLSNDparsingData(theFile7,0);
    assertFileInLSNDparsingData(theFile8,0);
    assertFileInLSNDparsingData(theFile9, 0);
    assertFileInLSNDparsingData(theFile10, 0);
    assertFileInLSNDparsingData(theFile11,0);
    assertFileInLSNDparsingData(theFile12,0);
    assertFileInLSNDparsingData(theFile13,0);
    assertFileInLSNDparsingData(theFile14, 0);
    assertFileInLSNDparsingData(theFile15, 0);
    assertFileInLSNDparsingData(theFile16,0);
    assertFileInLSNDparsingData(theFile17,0);
    assertFileInLSNDparsingData(theFile18,0);
    assertFileInLSNDparsingData(theFile19, 0);
    assertFileInLSNDparsingData(theFile20, 0);
    assertFileInLSNDparsingData(theFile21,0);
    assertFileInLSNDparsingData(theFile22,0);
    assertFileInLSNDparsingData(theFile23,0);
    assertFileInLSNDparsingData(theFile24, 0);
    assertFileInLSNDparsingData(theFile25, 0);
    assertFileInLSNDparsingData(theFile26,0);
    assertFileInLSNDparsingData(theFile27,0);
    assertFileInLSNDparsingData(theFile28,0);
    assertFileInLSNDparsingData(theFile29, 0);
    assertFileInLSNDparsingData(theFile30, 0);
